...
The keys live in `.claude/settings.json` (project) or `C:/Users/Nicolas/Desktop/Proyectos-Challenges/Prode-WC/ProdezoAppNuevo/frontend/.cursor/settings.json` (global) — **not** in `.planning/config.json`:
