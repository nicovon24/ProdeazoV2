...
```bash
INIT=$(node "C:/Users/Nicolas/Desktop/Proyectos-Challenges/Prode-WC/ProdezoAppNuevo/frontend/.cursor/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/Nicolas/Desktop/Proyectos-Challenges/Prode-WC/ProdezoAppNuevo/frontend/.cursor/get-shit-done/bin/gsd-tools.cjs" commit \
