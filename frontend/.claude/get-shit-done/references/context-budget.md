...
The keys live in `.claude/settings.json` (project) or `C:/Users/Nicolas/Desktop/Proyectos-Challenges/Prode-WC/ProdezoAppNuevo/frontend/.claude/settings.json` (global) — **not** in `.planning/config.json`:
