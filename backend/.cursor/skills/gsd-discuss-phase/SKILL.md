...
Read and execute `C:/Users/Nicolas/Desktop/Proyectos-Challenges/Prode-WC/ProdezoAppNuevo/backend/.cursor/get-shit-done/workflows/discuss-phase-assumptions.md` end-to-end.

If `DISCUSS_MODE` is `"discuss"` (or unset, or any other value):
Read and execute `C:/Users/Nicolas/Desktop/Proyectos-Challenges/Prode-WC/ProdezoAppNuevo/backend/.cursor/get-shit-done/workflows/discuss-phase.md` end-to-end.
